export const translations = {
  en: {
    ...
    "settings.providerConfigHint": "Binary, model, and tools — specific to this provider.",
    "settings.templatesTitle": "Prompt templates",
    "settings.templatesSharedHint":
      "Shared across every model — one set used by whichever provider is active (Claude, Gemini, …).",
    ...
    "settings.taskModelsTitle": "Model per task (advanced)",
    "settings.taskModelsHint":
      "Override the model for a specific action; leave it on the default to use the base model.",
    "settings.commitModelLabel": "Commit message",
    "settings.analyzeModelLabel": "Pre-commit analysis",
    "settings.reviewModelLabel": "PR review",
    "settings.modelSameAsBase": "Same as base model",
    "settings.modelFastDefault": "Fast model (recommended)",
    ...
    "settings.toolsNone": "No tools added yet.",
    ...
    "settings.analyzeTemplate": "Pre-commit analysis template",
    "settings.analyzeTemplateHint":
      "The instruction sent to Claude by the \"Analyze changes\" button in the Changes tab, scanning your not-yet-committed diff for bugs and vulnerabilities before you commit. Same finding format as the PR review template.",
    "settings.reset": "Reset",
    "settings.saved": "Saved",
    "settings.providerAppliedToast": "{provider} selected — now powering chat, PR review and analysis.",
    "settings.modelAppliedToast": "Model «{model}» applied for {provider}.",
    ...
    "analyze.button": "Analyze changes with Claude",
    ...
    "chat.hint": "Ask anything about this repository — Claude can read files, search code, and check git state to answer. Configure review contexts below for extra background.",
    "chat.configure": "Configure review contexts in Settings",
    "chat.copyMessage": "Copy message",
    "chat.copyAll": "Copy conversation",
    "chat.copied": "Copied",
    "chat.you": "You",
    ...
    "pr.findingsHeader": "Claude's findings ({n})",
    "pr.approve": "Approve",
  ...
  es: {
    ...
    "settings.providerConfigHint": "Binario, modelo y herramientas — propios de este proveedor.",
    "settings.templatesTitle": "Plantillas de prompts",
    "settings.templatesSharedHint":
      "Compartidas por todos los modelos — una sola que usa el proveedor activo (Claude, Gemini, …).",
    ...
    "settings.taskModelsTitle": "Modelo por tarea (avanzado)",
    "settings.taskModelsHint":
      "Sobrescribe el modelo de una acción concreta; déjalo por defecto para usar el modelo base.",
    "settings.commitModelLabel": "Mensaje de commit",
    "settings.analyzeModelLabel": "Análisis pre-commit",
    "settings.reviewModelLabel": "Revisión de PR",
    "settings.modelSameAsBase": "Igual que el modelo base",
    "settings.modelFastDefault": "Modelo rápido (recomendado)",
    ...
    "settings.toolsNone": "Aún no agregaste herramientas.",
    ...
    "settings.analyzeTemplate": "Plantilla de análisis pre-commit",
    "settings.analyzeTemplateHint":
      "La instrucción que se envía a Claude con el botón \"Analizar cambios\" de la pestaña Changes, revisando tu diff sin commitear en busca de bugs y vulnerabilidades antes de comitear. Usa el mismo formato de hallazgos que la plantilla de revisión de PR.",
    "settings.reset": "Restablecer",
    "settings.saved": "Guardado",
    "settings.providerAppliedToast": "{provider} seleccionado — ahora impulsa el chat, la revisión de PRs y el análisis.",
    "settings.modelAppliedToast": "Modelo «{model}» aplicado para {provider}.",
    ...
    "analyze.button": "Analizar cambios con Claude",
    ...
    "chat.hint": "Pregunta lo que sea sobre este repositorio — Claude puede leer archivos, buscar código y revisar el estado de git para responder. Configura contextos de revisión abajo para darle más contexto.",
    "chat.configure": "Configura los contextos de revisión en Configuración",
    "chat.copyMessage": "Copiar mensaje",
    "chat.copyAll": "Copiar conversación",
    "chat.copied": "Copiado",
    "chat.you": "Tú",
    ...
    "pr.findingsHeader": "Hallazgos de Claude ({n})",
    "pr.approve": "Aprobar",
