...
const ICON_BUTTON_SHELL =
  "flex h-[26px] w-[26px] shrink-0 items-center justify-center rounded-md transition-colors hover:bg-[var(--cf-hover)] disabled:cursor-not-allowed disabled:opacity-30";
