...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::stories_cmd::ado_parse_work_item_ref,
            commands::stories_cmd::ado_get_work_item,
            commands::stories_cmd::review_work_item,
            commands::stories_cmd::ado_update_work_item,
            commands::stories_cmd::ado_create_child_tasks,
